        ...
        try:
            ...
            with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
                ...
                while True:
                    ...
                    times = datetime.datetime.now().strftime("%I:%M%p on %B %d, %Y")
                    # Convert the formatted time string to bytes
                    data = bytes(times, encoding='utf-8')  
            ...
            print(f"Can't connect to the Socket {e}")  # If an exception occurs, print error message
